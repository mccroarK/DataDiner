    ...
    IEnumerator Recoil(AnimationCurve curve, Vector3 recoilMultiplier, float recoilTime)
    {
        ...
        while (currentRecoilTime < recoilTime)
        {
            ...
            _plaRecoilCamera.localRotation = Quaternion.Euler(
                _plaHeadBob.Evaluate(currentRecoilTime / recoilTime) * recoilMultiplier.x,
                _plaHeadBob.Evaluate(currentRecoilTime / recoilTime) * recoilMultiplier.y,
                _plaHeadBob.Evaluate(currentRecoilTime / recoilTime) * recoilMultiplier.z);
